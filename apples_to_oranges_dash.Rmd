...
output: 
  flexdashboard::flex_dashboard:
    ...
    navbar:
      ...
      - { title: "Experience", href: experience.html, align: right }
      - { icon: fa-envelope, href: mailto:<tlm2152@cumc.columbia.edu>, align: right }
      - { icon: fa-github, href: "http://github.com/tucker-l-morgan/", align: right }
      - { icon: fa-linkedin, href: "http://linkedin.com/in/tuckermo/", align: right }
      - { icon: fa-twitter, href: "https://twitter.com/Tuckerm_", align: right }
    theme: bootstrap
---
